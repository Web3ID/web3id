...
import KickBack from "@static/img/logo.png";
import FightSong from "@static/img/logo.png";
...
function Content() {
  return (
    ...
    >
      <h1 className="features-heading">Music NFT</h1>
      <h3 className="heading-md text-secondary">
        kami membantu para seniman musik
        membuatkan event，fans，dan karya digital ke pasar internasional
      </h3>
      <div className="h-stack mt-3">
        <LinkButton
          ...
          href="/docs"
        >
          Lihat Dokumentasi <BsArrowRightCircleFill className="inline" />
        </LinkButton>
      </div>
    </div>
  );
  ...
  return (
    <div className="flex w-full max-w-[400px] flex-col gap-3 rounded-2xl bg-white p-5 dark:bg-zinc-900">
      <div className="h-stack mb-2">
        <BsMusicNoteBeamed />
        <p className="font-bold">Web3IDN - Learn With Me</p>
      </div>
      <Progress track="w-[66%]" />
