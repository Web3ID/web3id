...
import { LearnPage } from "../../schema/learn";

export function LearnItem({ page }: { page: LearnPage }) {
...
export function LargeLearnItem({ page }: { page: LearnPage }) {
  const frontMatter = page.frontMatter;
  const title = getTitle(page);
